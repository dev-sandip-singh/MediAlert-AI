...
const userSchema = new mongoose.Schema({
  ...
  phone: {
    type: String,
    required: true,
    minLength: [10, " Phone Number is Required 10"],
    maxLength: [10, " Phone Number is Required 10"],
  },
  nic: {
    type: String,
    required: true,
    minLength: [5, " NIC Must Contain ONly 5 Digits is Required"],
    maxLength: [5, " NIC Must Contain ONly 5 Digits is Required"],
  },
  dob: {
    type: Date,
